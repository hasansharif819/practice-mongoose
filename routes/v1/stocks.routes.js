 ...
 */
    ...
    router.route('/bulk-update')
        .patch(stockController.bulkUpdateStocksById)
    
    //Bulk delete // Delete many products ById at a time
    router.route('/bulk-delete')
        .delete(stockController.bulkDeleteStocksById)
...
router.route('/:id')
        .get(stockController.findStockById)
        .patch(stockController.updateStockById)
        .delete(stockController.deletedStockById)
